...
if ! curl --create-dirs "https://raw.githubusercontent.com/JeffreyShran/dotFiles/master/.bash_aliases" -o ".bash_aliases"; then
  printf '(bash_aliases) Curl failed with error code "%d"\n' "$?" >&2
fi

if ! curl --create-dirs "https://raw.githubusercontent.com/JeffreyShran/dotFiles/master/.bash_profile" -o ".bash_profile"; then
